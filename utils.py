...
# Fonction retournant les coordonnées des coins d'un rectangle
...
# Fonction qui retourne la distance entre 2 points, utilisée pour la hitbox des CTA circulaires
